...
export const Route = createRootRouteWithContext<{
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Discover businesses that need websites, score opportunities, and win the work.",
      },
      { property: "og:title", content: "LeadForge" },
      { property: "og:description", content: "AI-powered lead generation and sales intelligence." },
