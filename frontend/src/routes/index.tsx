...
import { ArrowRight, BarChart3, CheckCircle2, Globe, MessagesSquare, Target, Zap } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Automate your client acquisition. LeadForge discovers local businesses, scores opportunities, and generates personalized outreach drafts.",
      },
    ],
  }),
    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-24 pb-32 lg:pt-36 lg:pb-40">
          ...
          <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="mx-auto max-w-4xl font-display text-5xl font-bold tracking-tight text-foreground sm:text-7xl">
              Turn local searches into <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-500">high-value clients</span>
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground leading-relaxed">
              Stop guessing who needs a website. LeadForge automatically discovers local businesses, scores their digital presence, and drafts hyper-personalized outreach.
            </p>
        ...
        <section className="border-y border-border/50 bg-muted/30 py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-50 grayscale">
              <div className="flex items-center gap-2 font-display text-xl font-bold"><Globe className="size-6" /> WebStudio</div>
              <div className="flex items-center gap-2 font-display text-xl font-bold"><Zap className="size-6" /> DevCraft</div>
              <div className="flex items-center gap-2 font-display text-xl font-bold"><Target className="size-6" /> LocalLeads</div>
              <div className="flex items-center gap-2 font-display text-xl font-bold"><BarChart3 className="size-6" /> GrowthDigital</div>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="py-24 sm:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center mb-16">
              <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">Everything you need to scale your outreach</h2>
              <p className="mt-4 text-lg text-muted-foreground">
                We've automated the most tedious parts of client acquisition so you can focus on closing deals.
              </p>
            </div>
        ...
        <section id="how-it-works" className="bg-muted/30 py-24 sm:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center mb-16">
              <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">How LeadForge works</h2>
              <p className="mt-4 text-lg text-muted-foreground">
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Manual prospecting is soul-crushing. LeadForge acts as your automated SDR, working 24/7 to build a pipeline of businesses that genuinely need your services.
                </p>
        ...
        <section id="pricing" className="bg-muted/30 py-24 sm:py-32 text-center">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="inline-block rounded-2xl border border-border bg-background p-8 shadow-sm w-full max-w-md mx-auto">
              ...
              <p className="text-muted-foreground mb-6">Create an account today to get early access and begin generating leads immediately.</p>
        ...
        <section id="faq" className="py-24 sm:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
            <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl text-center mb-12">Frequently Asked Questions</h2>
      ...
      <footer className="border-t border-border/50 bg-background py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-sm font-medium text-muted-foreground">
            <a href="mailto:support@leadforge.ai" className="hover:text-foreground transition-colors">Contact Support</a>
